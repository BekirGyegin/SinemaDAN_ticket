...
namespace ticket1.ticketDataSetTableAdapters {
    ...
    public partial class filmTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[film] WHERE (([film_id] = @Original_film_id) AND ((@IsNull_fil" +
                "m_name = 1 AND [film_name] IS NULL) OR ([film_name] = @Original_film_name)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[film] ([film_name]) VALUES (@film_name);\r\nSELECT film_id, film" +
                "_name FROM film WHERE (film_id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[film] SET [film_name] = @film_name WHERE (([film_id] = @Original_fi" +
                "lm_id) AND ((@IsNull_film_name = 1 AND [film_name] IS NULL) OR ([film_name] = @O" +
                "riginal_film_name)));\r\nSELECT film_id, film_name FROM film WHERE (film_id = @fil" +
                "m_id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT film_id, film_name FROM dbo.film";
        ...
        public virtual int Fill(ticketDataSet.filmDataTable dataTable) {
        ...
        public virtual ticketDataSet.filmDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            ticketDataSet.filmDataTable dataTable = new ticketDataSet.filmDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(ticketDataSet.filmDataTable dataTable) {
        ...
        public virtual int Delete(int Original_film_id, string Original_film_name) {
        ...
        public virtual int Update(string film_name, int Original_film_id, string Original_film_name, int film_id) {
            if ((film_name == null)) {
            ...
            this.Adapter.UpdateCommand.Parameters[1].Value = ((int)(Original_film_id));
            if ((Original_film_name == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[3].Value = ((string)(Original_film_name));
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string film_name, int Original_film_id, string Original_film_name) {
            return this.Update(film_name, Original_film_id, Original_film_name, Original_film_id);
        }
    }
